# Magisk supports overlayfs in v26.0 and newer [1], but some users are still
# running into trouble with BCR's files being mounted on MIUI. We'll keep this
# workaround of finding a non-overlayfs volume in place for now.
#
# [1] https://github.com/topjohnwu/Magisk/pull/6588
# [2] https://github.com/chenxiaolong/BCR/issues/322
